...
namespace MyBox {
  ...
  /// </summary>
  public class DropDownValuesAttribute : PropertyAttribute {
    public readonly object[] ValuesArray;

    public DropDownValuesAttribute(params object[] definedValues) {
...
namespace MyBox.Internal {
  [CustomPropertyDrawer(typeof(DropDownValuesAttribute))]
  public class DropDownValuesAttributeDrawer : PropertyDrawer {
    private DropDownValuesAttribute _attribute;
    ...
    private void Initialize(SerializedProperty property) {
      _attribute = (DropDownValuesAttribute)attribute;
